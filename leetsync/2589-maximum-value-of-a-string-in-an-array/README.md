<h2><a href="https://leetcode.com/problems/maximum-value-of-a-string-in-an-array">Maximum Value of a String in an Array</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>The <strong>value</strong> of an alphanumeric string can be defined as:</p>
